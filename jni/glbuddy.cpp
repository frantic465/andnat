...
extern "C" {
    JNIEXPORT void JNICALL Java_com_frantic465_glbuddy_JniLib_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_frantic465_glbuddy_JniLib_resize(JNIEnv* env, jobject obj, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_frantic465_glbuddy_JniLib_step(JNIEnv* env, jobject obj);
};
...
Java_com_frantic465_glbuddy_JniLib_init(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
JNIEXPORT void JNICALL
Java_com_frantic465_glbuddy_JniLib_resize(JNIEnv* env, jobject obj, jint width, jint height) {
    if (g_renderer) {
...
JNIEXPORT void JNICALL
Java_com_frantic465_glbuddy_JniLib_step(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        g_renderer->render();
    }
}
